...
import org.jbpm.persistence.mongodb.test.object.MyObject;
...
public abstract class HTWorkItemHandlerBaseTest extends AbstractMongoBPMBaseTest {
    ...
    public void testTask() throws Exception {
        ...
        handler.executeWorkItem(workItem, getKSession().getWorkItemManager());
    ...
    public void testTaskGroupActors() throws Exception {
        ...
        workItem.setProcessInstanceId(10);
        getHandler().executeWorkItem(workItem, getKSession().getWorkItemManager());
    ...
    public void testTaskFail() throws Exception {
        ...
        task = taskService.getTaskById(taskSummary.getId());
    ...
    public void testTaskAbortSkippable() throws Exception {
        ...
        workItem.setProcessInstanceId(10);
        getHandler().executeWorkItem(workItem, getKSession().getWorkItemManager());
        getHandler().abortWorkItem(workItem, getKSession().getWorkItemManager());
