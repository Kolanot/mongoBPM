...
import org.jbpm.persistence.mongodb.test.object.MyError;
...
public class IntermediateEventTest extends JbpmBpmn2TestCase {
    ...
    public IntermediateEventTest() {
    	super();
    }

    @Test
    public void testSignalBoundaryEvent() throws Exception {
        KieSession ksession = createNewSession(
    ...
    public void testSignalBoundaryEventOnTask() throws Exception {
        KieSession ksession = createNewSession("BPMN2-BoundarySignalEventOnTaskbpmn2.bpmn");
        ksession.getWorkItemManager().registerWorkItemHandler("Human Task",
    ...
    public void testSignalBoundaryEventInterrupting() throws Exception {
    	KieSession ksession = createNewSession("BPMN2-SignalBoundaryEventInterrupting.bpmn2");
    ...
    public void testSignalIntermediateThrow() throws Exception {
    	KieSession ksession = createNewSession("BPMN2-IntermediateThrowEventSignal.bpmn2");
    ...
    public void testEventBasedSplit() throws Exception {
    	KieSession ksession = createNewSession("BPMN2-EventBasedSplit.bpmn2");
    ...
    public void testEventBasedSplit2() throws Exception {
    	KieSession ksession = createNewSession("BPMN2-EventBasedSplit2.bpmn2");
        ksession.getWorkItemManager().registerWorkItemHandler("Email1",
                new SystemOutWorkItemHandler());
        ksession.getWorkItemManager().registerWorkItemHandler("Email2",
                new SystemOutWorkItemHandler());
    ...
    public void testEventBasedSplit3() throws Exception {
    	KieSession ksession = createNewSession("BPMN2-EventBasedSplit3.bpmn2");
        ksession.getWorkItemManager().registerWorkItemHandler("Email1",
                new SystemOutWorkItemHandler());
        ksession.getWorkItemManager().registerWorkItemHandler("Email2",
                new SystemOutWorkItemHandler());
    ...
    public void testEventBasedSplit4() throws Exception {
    	KieSession ksession = createNewSession("BPMN2-EventBasedSplit4.bpmn2");
        ksession.getWorkItemManager().registerWorkItemHandler("Email1",
                new SystemOutWorkItemHandler());
        ksession.getWorkItemManager().registerWorkItemHandler("Email2",
                new SystemOutWorkItemHandler());
    ...
    public void testEventBasedSplit5() throws Exception {
    	KieSession ksession = createNewSession("BPMN2-EventBasedSplit5.bpmn2");
        ksession.getWorkItemManager().registerWorkItemHandler("Email1",
                new SystemOutWorkItemHandler());
        ksession.getWorkItemManager().registerWorkItemHandler("Email2",
                new SystemOutWorkItemHandler());
    ...
    public void runTestEventSubprocessSignal(String processFile, String [] completedNodes) throws Exception { 
    	KieSession ksession = createNewSession(processFile);
    ...
    public void testEventSubprocessSignalWithStateNode() throws Exception {
    	KieSession ksession = createNewSession("BPMN2-EventSubprocessSignalWithStateNode.bpmn2");
        final List<Long> executednodes = new ArrayList<Long>();
        ProcessEventListener listener = new DefaultProcessEventListener() {
    ...
    public void testEventSubprocessSignalInterrupting() throws Exception {
    	KieSession ksession = createNewSession("BPMN2-EventSubprocessSignalInterrupting.bpmn2");
        final List<Long> executednodes = new ArrayList<Long>();
        ProcessEventListener listener = new DefaultProcessEventListener() {
    ...
    public void testEventSubprocessMessage() throws Exception {
    	KieSession ksession = createNewSession("BPMN2-EventSubprocessMessage.bpmn2");
        final List<Long> executednodes = new ArrayList<Long>();
        ProcessEventListener listener = new DefaultProcessEventListener() {
    ...
    public void testEventSubprocessEscalation() throws Exception {
        KieSession ksession = createNewSession("BPMN2-EventSubprocessEscalation.bpmn2");
        final List<Long> executednodes = new ArrayList<Long>();
        ProcessEventListener listener = new DefaultProcessEventListener() {
    ...
    public void testEventSubprocessError() throws Exception {
        KieSession ksession = createNewSession("BPMN2-EventSubprocessError.bpmn2");
        final List<Long> executednodes = new ArrayList<Long>();
        ProcessEventListener listener = new DefaultProcessEventListener() {
    ...
    public void testEventSubprocessTimer() throws Exception {
        KieSession ksession = createNewSession("BPMN2-EventSubprocessTimer.bpmn2");
        final List<Long> executednodes = new ArrayList<Long>();
        ProcessEventListener listener = new DefaultProcessEventListener() {
    ...
    public void testEventSubprocessTimerCycle() throws Exception {
        KieSession ksession = createNewSession("BPMN2-EventSubprocessTimerCycle.bpmn2");
        final List<Long> executednodes = new ArrayList<Long>();
        ProcessEventListener listener = new DefaultProcessEventListener() {
    ...
    public void testEventSubprocessConditional() throws Exception {
        KieSession ksession = createNewSession("BPMN2-EventSubprocessConditional.bpmn2");
        final List<Long> executednodes = new ArrayList<Long>();
        ProcessEventListener listener = new DefaultProcessEventListener() {
    ...
    public void testMessageIntermediateThrow() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateThrowEventMessage.bpmn2");
    ...
    public void testEscalationBoundaryEvent() throws Exception {
        KieSession ksession = createNewSession("BPMN2-EscalationBoundaryEvent.bpmn2");
    ...
    public void testEscalationBoundaryEventInterrupting() throws Exception {
        KieSession ksession = createNewSession("BPMN2-EscalationBoundaryEventInterrupting.bpmn2");
    ...
    public void testEscalationBoundaryEventOnTask() throws Exception {
        KieSession ksession = createNewSession("BPMN2-EscalationBoundaryEventOnTask.bpmn2");
    ...
    public void testEscalationIntermediateThrowEventProcess() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateThrowEventEscalation.bpmn2");
    ...
    public void testErrorBoundaryEvent() throws Exception {
        KieSession ksession = createNewSession("BPMN2-ErrorBoundaryEventInterrupting.bpmn2");
    ...
    public void testErrorBoundaryEventOnTask() throws Exception {
        KieSession ksession = createNewSession("BPMN2-ErrorBoundaryEventOnTask.bpmn2");
    ...
    public void testErrorBoundaryEventOnServiceTask() throws Exception {
        KieSession ksession = createNewSession("BPMN2-ErrorBoundaryEventOnServiceTask.bpmn2");
    ...
    public void testTimerBoundaryEventDuration() throws Exception {
        KieSession ksession = createNewSession("BPMN2-TimerBoundaryEventDuration.bpmn2");
    ...
    public void testTimerBoundaryEventDurationISO() throws Exception {
        KieSession ksession = createNewSession("BPMN2-TimerBoundaryEventDurationISO.bpmn2");
    ...
    public void testTimerBoundaryEventDateISO() throws Exception {
        KieSession ksession = createNewSession("BPMN2-TimerBoundaryEventDateISO.bpmn2");
    ...
    public void testTimerBoundaryEventCycle1() throws Exception {
        KieSession ksession = createNewSession("BPMN2-TimerBoundaryEventCycle1.bpmn2");
    ...
    public void testTimerBoundaryEventCycle2() throws Exception {
        KieSession ksession = createNewSession("BPMN2-TimerBoundaryEventCycle2.bpmn2");
    ...
    public void testTimerBoundaryEventCycleISO() throws Exception {
        KieSession ksession = createNewSession("BPMN2-TimerBoundaryEventCycleISO.bpmn2");
    ...
    public void testTimerBoundaryEventInterrupting() throws Exception {
        KieSession ksession = createNewSession("BPMN2-TimerBoundaryEventInterrupting.bpmn2");
    ...
    public void testTimerBoundaryEventInterruptingOnTask() throws Exception {
        KieSession ksession = createNewSession("BPMN2-TimerBoundaryEventInterruptingOnTask.bpmn2");
    ...
    public void testIntermediateCatchEventSignal() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateCatchEventSignal.bpmn2");
    ...
    public void testIntermediateCatchEventMessage() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateCatchEventMessage.bpmn2");
    ...
    public void testIntermediateCatchEventTimerDuration() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateCatchEventTimerDuration.bpmn2");
    ...
    public void testIntermediateCatchEventTimerDateISO() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateCatchEventTimerDateISO.bpmn2");
    ...
    public void testIntermediateCatchEventTimerDurationISO() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateCatchEventTimerDurationISO.bpmn2");
    ...
    public void testIntermediateCatchEventTimerCycle1() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateCatchEventTimerCycle1.bpmn2");
    ...
    public void testIntermediateCatchEventTimerCycleISO() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateCatchEventTimerCycleISO.bpmn2");
    ...
    public void testIntermediateCatchEventTimerCycle2() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateCatchEventTimerCycle2.bpmn2");
    ...
    public void testIntermediateCatchEventCondition() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateCatchEventCondition.bpmn2");
    ...
    public void testIntermediateCatchEventConditionFilterByProcessInstance()
            throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateCatchEventConditionFilterByProcessInstance.bpmn2");
    ...
    public void testIntermediateCatchEventTimerCycleWithError()
            throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateCatchEventTimerCycleWithError.bpmn2");
    ...
    public void testCompensateIntermediateThrowEventProcess() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateThrowEventCompensate.bpmn2");
    ...
    public void testNoneIntermediateThrow() throws Exception {
        KieSession ksession = createNewSession("BPMN2-IntermediateThrowEventNone.bpmn2");
    ...
    public void testLinkIntermediateEvent() throws Exception {
        ...
        KieSession ksession = createNewSession("BPMN2-IntermediateLinkEvent.bpmn2");
    ...
    public void testLinkEventCompositeProcess() throws Exception {
        KieSession ksession = createNewSession("BPMN2-LinkEventCompositeProcess.bpmn2");
    ...
    public void testConditionalBoundaryEventOnTask() throws Exception {
        KieSession ksession = createNewSession("BPMN2-BoundaryConditionalEventOnTask.bpmn2");
    ...
    public void testConditionalBoundaryEventInterrupting() throws Exception {
        KieSession ksession = createNewSession("BPMN2-ConditionalBoundaryEventInterrupting.bpmn2");
    ...
    public void testErrorSignallingExceptionServiceTask() throws Exception {
        KieSession ksession = createNewSession("BPMN2-ExceptionServiceProcess-ErrorSignalling.bpmn2");
    ...
    public void testSignallingExceptionServiceTask() throws Exception {
        KieSession ksession = createNewSession("BPMN2-ExceptionServiceProcess-Signalling.bpmn2");
