 ...
 *
 */
public class GlobalMongoTimerJobInstance extends DefaultTimerJobInstance {

    private static final long serialVersionUID = -5383556604449217342L;
    private String timerServiceId;

    public GlobalMongoTimerJobInstance(Job job, JobContext ctx, Trigger trigger,
    ...
    public Void call() throws Exception {
        ...
        try { 
            MongoJDKCallableJobCommand command = new MongoJDKCallableJobCommand( this );
            if (scheduler == null) {
