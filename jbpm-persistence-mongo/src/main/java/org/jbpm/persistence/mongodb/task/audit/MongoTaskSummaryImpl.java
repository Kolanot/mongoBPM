 ...
 */
package org.jbpm.persistence.mongodb.task.audit;

import java.io.Serializable;
import java.util.Date;

public class MongoTaskSummaryImpl implements Serializable {
    ...
    public MongoTaskSummaryImpl() {
    }

    public MongoTaskSummaryImpl(long taskId, String name,  String status, Date createdDate, String userId, long processInstanceId) {
        this.taskId = taskId;
        this.taskName = name;
        this.userId = userId;
        this.status = status;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MongoTaskSummaryImpl other = (MongoTaskSummaryImpl) obj;
		if (createdDate == null) {
