...
public class MongoTaskDataImpl implements InternalTaskData {
    ...
    public void readExternal(ObjectInput in) throws IOException,
        ...
        if (in.readBoolean()) {
            actualOwner = new MongoUserImpl();
            actualOwner.readExternal(in);
        }

        if (in.readBoolean()) {
            createdBy = new MongoUserImpl();
    ...
    public void addComment(Comment comment) {
        ...
        comments.add((MongoCommentImpl) comment);
    }
    ...
    public void addAttachment(Attachment attachment) {
        ...
        attachments.add((MongoAttachmentImpl) attachment);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof MongoTaskDataImpl)) return false;
        MongoTaskDataImpl other = (MongoTaskDataImpl) obj;
