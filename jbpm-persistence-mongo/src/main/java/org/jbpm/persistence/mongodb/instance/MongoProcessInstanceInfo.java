...
public class MongoProcessInstanceInfo implements Serializable {
	...
	@Property
	protected long nodeInstanceCounter;
	@Property
	...
	@Embedded
	private List<MongoTaskImpl> tasks = new ArrayList<MongoTaskImpl>();
	...
	public List<MongoTaskImpl> getTasks() {
		return tasks;
	}
	...
	public void addWorkItem(WorkItem workItem, long workItemId) {
		MongoWorkItemInfo workItemInfo = new MongoWorkItemInfo(workItem,
				workItemId);
	...
	public MongoWorkItemInfo getWorkItem(long workItemId) {
		for (MongoWorkItemInfo workItemInfo : workItems) {
			if (workItemInfo.getId() == workItemId)
				return workItemInfo;
		}
		return null;
	}
	...
	public int hashCode() {
		...
		hash = 61
				* hash
				+ (processInstanceId != null ? processInstanceId.hashCode() : 0);
	...
	public void assignCorrelationKey(String keyName, String propertyName,
			String propertyValue) {
		MongoCorrelationKey correlationKey = new MongoCorrelationKey(keyName,
